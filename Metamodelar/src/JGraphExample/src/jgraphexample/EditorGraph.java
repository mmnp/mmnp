...
package jgraphexample;
        ...
        public class EditorGraph extends JGraph {
            ...
            public static void main(String[] args) {
                final JFrame frame = new JFrame("EditorGraph");
            ...
            public class EditorGraphUI extends BasicGraphUI {
                ...
                protected void completeEditing(boolean messageStop,
                    ...
                    if (stopEditingInCompleteEditing
                            && editingComponent != null && editDialog != null) {
                        Object oldCell = editingCell;
                        GraphCellEditor oldEditor = cellEditor;
                        Object newValue = oldEditor.getCellEditorValue();
                        boolean requestFocus = (graph != null && (graph
                                .hasFocus() || editingComponent.hasFocus()));
                        editingCell = null;
                        ...
                        if (requestFocus)
                            graph.requestFocus();
                        if (messageGraph) {
                            graphLayoutCache.valueForCellChanged(oldCell,
                                    newValue);
                        }
                        updateSize();
                ...
                protected boolean startEditing(Object cell, MouseEvent event) {
                    ...
                    if (graph.isCellEditable(cell) && editDialog == null) {
                        ...
                        editingComponent = cellEditor
                                .getGraphCellEditorComponent(graph, cell, graph
                                        .isCellSelected(cell));
                        if (cellEditor.isCellEditable(event)) {
                            ...
                            if (cellEditor.shouldSelectCell(event)) {
                                ...
                                try {
                                    ...
                                    System.err.println("Editing exception: "
                                            + e);
                                }
                            ...
                            if (event instanceof  MouseEvent) {
                                ...
                                Point componentPoint = SwingUtilities
                                        .convertPoint(graph, new Point(event
                                                .getX(), event.getY()),
                                                editingComponent);
